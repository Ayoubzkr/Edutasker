...
<b class="display-6">Devoirs - <small>Mathématiques</small></b><br>
...
?>
<div class="table-responsive"><br>
<b class="display-6">Devoirs - <small>Physique</small></b><br>
    <table class="table table-striped table-hover table-responsive" id="dataTable">
        <thead>
            <tr>
                <th scope="col">Titre</th>
...
?>
<div class="table-responsive"><br>
<b class="display-6">Devoirs - <small>Français</small></b><br>
    <table class="table table-striped table-hover table-responsive" id="dataTable">
        <thead>
            <tr>
                <th scope="col">Titre</th>
...
?>
<div class="table-responsive"><br>
<b class="display-6">Devoirs - <small> Littérature</small></b><br>
    <table class="table table-striped table-hover table-responsive" id="dataTable">
        <thead>
            <tr>
                <th scope="col">Titre</th>
...
?>
<div class="table-responsive"><br>
<b class="display-6">Devoirs - <small>Histoire</small></b><br>
    <table class="table table-striped table-hover table-responsive" id="dataTable">
        <thead>
            <tr>
                <th scope="col">Titre</th>
...
?>
<div class="table-responsive"><br>
<b class="display-6">Devoirs - <small>Biologie</small></b><br>
    <table class="table table-striped table-hover table-responsive" id="dataTable">
        <thead>
            <tr>
                <th scope="col">Titre</th>
