...
<body>
  <div class="sidebar">
    ...
    <a href="/edutasker/dashboard.php" style="<?php if($active==1)echo 'background-color: #fff; color: #3f5efb; border-radius: 0 20px 20px 0;';?>"><i class="fas fa-home"></i> Tableau de bord</a>
    
    <a class="dropdown-btn" onclick="toggleDropdown('ecoles')" style="<?php if($active==2)echo 'background-color: #fff; color: #3f5efb; border-radius: 0 20px 20px 0;';?>"><i class="fas fa-school"></i> Gestion des Écoles 
      <span style="margin-left:auto;"><i class="fas fa-caret-down"></i></span>
    </a>
    <div id="ecoles" class="dropdown-container">
      <a href="/edutasker/ecole/ecole-form-add.php"><i class="fas fa-plus-circle"></i> Ajouter une école</a>
      <a href="/edutasker/ecole/ecole-list.php"><i class="fas fa-eye"></i> Voir les écoles</a>
    </div>
    
    <a class="dropdown-btn" onclick="toggleDropdown('professeurs')" style="<?php if($active==3)echo 'background-color: #fff; color: #3f5efb; border-radius: 0 20px 20px 0;';?>"><i class="fas fa-chalkboard-teacher"></i> Gestion des paiement 
      <span style="margin-left:auto;"><i class="fas fa-caret-down"></i></span>
    </a>
    <div id="professeurs" class="dropdown-container">
      <a href="/edutasker/paiement/paiement-list.php"><i class="fas fa-user-plus"></i> Voir les paiements </a>
      <a href="/edutasker/plan/plan-list.php"><i class="fas fa-eye"></i> Plan des paiements</a>
    </div>
